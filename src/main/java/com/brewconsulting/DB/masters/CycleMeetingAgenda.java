        ...
        if(Permissions.isAuthorised(userRole,CycleMeetingAgenda).equals("Write"))
        {
            ...
            try {
                ...
                stmt = con.prepareStatement("SELECT sessionname, sessiondesc, sessionstarttime," +
                        "sessionendtime,contenttype FROM "+schemaName+".groupagenda where groupid = ? and dayNo = ?");
                ...
                while (result.next())
                {
                    ...
                    cycleMeetingAgenda.contentType = result.getString(5);
                ...
                if (con != null) {
                    stmt = con
                            .prepareStatement("SELECT id, cyclemeetingid, meetingdate, sessionname, sessiondesc, sessionstarttime," +
                                    "sessionendtime, createdon, createdby, updateon, updatedby, contenttype " +
